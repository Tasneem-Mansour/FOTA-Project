...
function upload() {
    ...
    if (text != null) {
        ...
        const http = new EasyHTTP;
     			...
     			http.put('https://fir-led-sing-default-rtdb.asia-southeast1.firebasedatabase.app/line.json', array)
            	.then(data => {
            	       const code_data = {
           				 lines: array.length,
           				 new: true,
                ...
                http.put('https://fir-led-sing-default-rtdb.asia-southeast1.firebasedatabase.app/code.json', code_data)
                .then(data => {
...
async function testConnection() {
    ...
    test('https://fir-led-sing-default-rtdb.asia-southeast1.firebasedatabase.app/connection.json').then(
        () => {
